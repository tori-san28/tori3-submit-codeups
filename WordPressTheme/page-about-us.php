...
<main>
    <section class="sub-main-visual sub-main-visual--campaign page-sub-main-visual">
      ...
      <div class="sub-main-visual__item">
        <picture>
          <source media='(min-width: 768px)' srcset='<?php echo esc_url(get_theme_file_uri());?>/assets/images/common/aboutus-sub-mv-pc.webp'>
          <img src='<?php echo esc_url(get_theme_file_uri());?>/assets/images/common/aboutus-sub-mv-sp.webp' alt='aboutus-mv'>
        </picture>
      </div>
    </section>
            ...
            <?php  foreach($pictures as $item): ?>
              <div class="gallery__img js-openModal">
                <?php if(!empty($item['picture1'])):?>
                    ...
                    <?php $image_large = wp_get_attachment_image_src($item['picture1'] , 'large'); ?>
                 <picture>
                  <source media='(min-width: 768px)' srcset='<?php echo esc_url($image_full[0]); ?>'>
                  <img src='<?php echo esc_url($image_large[0]); ?>' alt='gallery-picture'>
                 </picture>
                <?php endif;?>
              </div>
            <?php endforeach;?> 
